...
TELEMETRY_GROUPS = {
    ...
    "System memory (8x64 GB DDR5 ECC RDIMM)": tuple(
...
METRIC_UNITS = {
    ...
    "motherboard_temp_c": "\N{DEGREE SIGN}C",
    "chipset_temp_c": "\N{DEGREE SIGN}C",
    "vrm_e_temp_c": "\N{DEGREE SIGN}C",
    "vrm_w_temp_c": "\N{DEGREE SIGN}C",
    "ram_1_temp_c": "\N{DEGREE SIGN}C",
    "ram_2_temp_c": "\N{DEGREE SIGN}C",
    "ram_3_temp_c": "\N{DEGREE SIGN}C",
    "ram_4_temp_c": "\N{DEGREE SIGN}C",
    "ram_5_temp_c": "\N{DEGREE SIGN}C",
    "ram_6_temp_c": "\N{DEGREE SIGN}C",
    "ram_7_temp_c": "\N{DEGREE SIGN}C",
    "ram_8_temp_c": "\N{DEGREE SIGN}C",
    ...
    "nvme_1_temp_c": "\N{DEGREE SIGN}C",
    "nvme_2_temp_c": "\N{DEGREE SIGN}C",
...
METRIC_LABELS = {
    ...
    "motherboard_temp_c": "Motherboard temperature",
    "chipset_temp_c": "Chipset temperature",
    "vrm_e_temp_c": "VRM East temperature",
    "vrm_w_temp_c": "VRM West temperature",
    "ram_1_temp_c": "DIMM 1 temperature",
    "ram_2_temp_c": "DIMM 2 temperature",
    "ram_3_temp_c": "DIMM 3 temperature",
    "ram_4_temp_c": "DIMM 4 temperature",
    "ram_5_temp_c": "DIMM 5 temperature",
    "ram_6_temp_c": "DIMM 6 temperature",
    "ram_7_temp_c": "DIMM 7 temperature",
    "ram_8_temp_c": "DIMM 8 temperature",
    ...
    "nvme_1_temp_c": "NVMe 1 temperature",
    "nvme_2_temp_c": "NVMe 2 temperature",
