...
start "Blackwell Monitoring Suite" "%BMS_KIT_RELEASE%\kit\kit.exe" "%APP_KIT%" --ext-folder "%BMS_KIT_RELEASE%\exts" --ext-folder "%BMS_KIT_RELEASE%\extscache" --ext-folder "%BMS_KIT_RELEASE%\apps"
popd
